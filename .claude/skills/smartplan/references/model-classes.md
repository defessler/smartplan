...
| Gemini 3.8 Flash | Implementer (provisional) | **0.75 / 3.75** (cache-read 0.075, the same `gemini-flash-promo` footnote as 3.6 and 3.7 Flash through 2026-12-31, then 1.50 / 7.50 from 2027-01-01) | **vals.ai SWE-V 80.0** (independent, read 2026-09-15) · **Terminal-Bench 4.0 #10 at 19.1% ± 3.4%** (official board, read 2026-09-15), above GPT-5.6 Luna's 17.3% · AA Intelligence Index v4.3 41 at `high` | provisional (Copilot GA 2026-09-03, every paid plan including plain Pro) | 2026-09-15 | GitHub's named successor for both Gemini 3.5 Flash and Gemini 3.6 Flash when they leave Copilot on 2026-10-02, and 3.6 Flash holds the cross-family verifier seat. Same price as 3.6 and 3.7 Flash under the same footnote. The seat moved to 3.6 only after T34 cleared it at 8/8 seeded recall, so run that trial here before re-pinning. Class is provisional until it does |
