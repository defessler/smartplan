...
The validation matrix and sources moved to `cpp-review-standards-provenance.md` (same directory) on 2026-09-07, keeping 19KB of provenance out of the review-time load.
The three knobs below are the part of that section a reviewer still needs.
