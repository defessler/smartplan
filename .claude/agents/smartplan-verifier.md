...
model: sonnet
effort: high  # coverage over caution at the gate. It rides the Strong per-call model opus override too, so that verify runs Opus 5.5 at high (probed 2026-09-22 on 2.1.280)
